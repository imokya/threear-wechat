...
export class ARToolKitController {
	 ...
	 */
	public process(imageData: any) {
		this.detectMarker(imageData);
	 ...
	 */
	public detectMarker(imageData: any) {
		if (this._copyImageToHeap(imageData)) {
	 ...
	 * @private
	 */
	private _copyImageToHeap(imageData: any) {
		if (!imageData) {
			imageData = this.imageData;
		}

		if (this.dataHeap) {
			this.dataHeap.set(imageData);
			return true;
		}
